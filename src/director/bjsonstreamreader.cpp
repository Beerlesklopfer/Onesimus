...
#ifdef DEBUG_JSON
        BLOG_DEBUG() << "BJsonStreamReader: JSON is direct array";
#endif
...
#ifdef DEBUG_JSON
        BLOG_DEBUG() << "BJsonStreamReader: JSON is neither array nor object";
#endif
        return QJsonArray();
    }
...
#ifdef DEBUG_JSON
    BLOG_DEBUG() << "BJsonStreamReader: JSON root keys:" << root.keys();
#endif
...
#ifdef DEBUG_JSON
            BLOG_DEBUG() << "BJsonStreamReader: Found jobs in result.jobs";
#endif
...
#ifdef DEBUG_JSON
        BLOG_DEBUG() << "BJsonStreamReader: Found jobs in root.jobs";
#endif
        return root["jobs"].toArray();
    }

#ifdef DEBUG_JSON
    BLOG_DEBUG() << "BJsonStreamReader: No jobs array found";
#endif
